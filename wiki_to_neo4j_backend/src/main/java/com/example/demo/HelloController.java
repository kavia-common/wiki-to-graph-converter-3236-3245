...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for wikitoneo4jbackend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to wikitoneo4jbackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: wikitoneo4jbackend";
    }
} 